...
* Service tests: grant negotiation for all-granted, one-denied, all-denied; API-key mode leaves groups unknown; `updateRomProps` sends the bare body and query flag; favourites collection created once.
