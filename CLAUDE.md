...
- Architecture Decision Records are in `sdd/adrs/`
- Specifications are in `sdd/specs/`
...
| `/sdd:report-friction` | File a feedback issue against the SDD plugin (joestump/claude-plugin-sdd) when… |
| `/sdd:respond` | Respond to review feedback on a PR — gather review comments, requested changes… |
| `/sdd:search` | Unified semantic exploration skill combining qmd hybrid retrieval with cgg call… |` marker with the
...
- **SPEC-0002 Project**: 22 (https://github.com/users/jonstump/projects/22)
...
- **SPEC-0007 Project**: 27 (https://github.com/users/jonstump/projects/27)
- **SPEC-0008 Project**: 28 (https://github.com/users/jonstump/projects/28)
- **SPEC-0009 Project**: 29 (https://github.com/users/jonstump/projects/29)
- **SPEC-0010 Project**: 30 (https://github.com/users/jonstump/projects/30)
- **SPEC-0011 Project**: 31 (https://github.com/users/jonstump/projects/31)
- **SPEC-0012 Project**: 32 (https://github.com/users/jonstump/projects/32)
- **SPEC-0013 Project**: 33 (https://github.com/users/jonstump/projects/33)
- **SPEC-0014 Project**: 34 (https://github.com/users/jonstump/projects/34)
- **SPEC-0015 Project**: 35 (https://github.com/users/jonstump/projects/35)
- **SPEC-0016 Project**: 36 (https://github.com/users/jonstump/projects/36)
