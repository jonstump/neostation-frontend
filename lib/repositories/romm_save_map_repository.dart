...
class RommSaveMapRepository {
  ...
  ///
  /// Unlike the other reads here this one **throws** when the lookup itself
  /// fails: null means "no link", which the flush acts on by dropping the
  /// pending row, and a database error must not be mistaken for that.
