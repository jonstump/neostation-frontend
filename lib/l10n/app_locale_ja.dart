...
const Map<String, dynamic> appLocaleJa = {
  ...
  AppLocale.rommFilterMenuTitle: 'フィルター',
  AppLocale.rommFilterMenuAction: 'フィルター',
  AppLocale.rommFilterFavorites: 'お気に入り',
  AppLocale.rommFilterHasSaves: 'セーブあり',
  AppLocale.rommFilterHasStates: 'ステートセーブあり',
  AppLocale.rommFilterHasAchievements: '実績あり',
  AppLocale.rommFilterPlayable: 'プレイ可能',
  AppLocale.rommFilterDuplicates: '重複',
  AppLocale.rommFilterMissing: 'ファイルなし',
  AppLocale.rommFilterChipsLabel: 'フィルター:',
  AppLocale.rommFilterClearAll: 'フィルターを解除',
  AppLocale.rommFilterNoMatches: 'このフィルターに一致する ROM はありません',
  AppLocale.rommSurpriseMe: 'おまかせ',
  AppLocale.rommSurpriseMeEmpty: 'ここには選べるものがありません',
  ...
  AppLocale.rommMaintenanceRescanConfirm:
      'RomM がライブラリ全体を再スキャンします。大きなサーバーでは時間がかかることがあります。',
  AppLocale.rommMaintenanceSyncFolders: 'フォルダースキャンを同期',
  AppLocale.rommMaintenanceSyncFoldersConfirm:
      'RomM が ROM フォルダーを読み直し、アプリの外で追加・削除されたファイルを取り込みます。',
  AppLocale.rommMaintenanceCleanup: '見つからない ROM を整理',
  AppLocale.rommMaintenanceCleanupConfirm:
      'RomM がサーバー上にファイルのないライブラリ項目を削除します。元に戻せません。',
  AppLocale.rommMaintenanceRun: '実行',
  AppLocale.rommMaintenanceQueued: 'サーバーでタスクを予約しました',
  AppLocale.rommMaintenanceBusy: 'そのタスクはすでに実行中です',
  AppLocale.rommMaintenanceFailed: 'タスクを開始できませんでした',
  AppLocale.rommFixMatchAction: 'RomM の一致を修正',
  AppLocale.rommChangeCoverAction: 'カバーを変更',
  AppLocale.rommFixMatchTitle: 'RomM の一致を修正',
  AppLocale.rommChangeCoverTitle: 'RomM のカバーを変更',
  AppLocale.rommFixMatchSearchHint: 'サーバーのメタデータ提供元を検索',
  AppLocale.rommFixMatchLoading: 'RomM に問い合わせています…',
  AppLocale.rommFixMatchNoResults: '候補が見つかりませんでした',
  AppLocale.rommFixMatchNoSource: 'この RomM サーバーではメタデータ提供元が一つも有効になっていません',
  AppLocale.rommFixMatchFailed: 'RomM の検索に失敗しました — 選択して再試行',
  AppLocale.rommFixMatchConfirmTitle: 'この一致を適用しますか？',
  AppLocale.rommFixMatchConfirmBody:
      'RomM はすべてのクライアントに対してこのゲームを「{name}」として保存し、ローカルのメタデータも RomM の内容で置き換えられます。',
  AppLocale.rommChangeCoverConfirmTitle: 'このカバーを適用しますか？',
  AppLocale.rommChangeCoverConfirmBody:
      'RomM はすべてのクライアントに対して「{name}」にこのカバーを保存し、ローカルの画像も RomM の内容で置き換えられます。',
  AppLocale.rommFixMatchApply: 'RomM に適用',
  AppLocale.rommFixMatchApplying: 'RomM に適用しています…',
  AppLocale.rommFixMatchApplied: 'RomM に一致を適用しました',
  AppLocale.rommChangeCoverApplied: 'RomM にカバーを適用しました',
  ...
  AppLocale.neoSyncNetworkError: 'ネットワークエラー: {error}',
  AppLocale.neoSyncServerError: 'サーバーエラー: {error}',
  AppLocale.neoSyncLoginFailed: 'ログインに失敗しました',
  AppLocale.neoSyncRegistrationFailed: '登録に失敗しました',
  AppLocale.neoSyncVerificationFailed: '確認に失敗しました',
  AppLocale.neoSyncResendVerificationFailed: '確認メールの送信に失敗しました',
  AppLocale.neoSyncPasswordResetEmailFailed: 'パスワードリセットメールの送信に失敗しました',
  AppLocale.neoSyncPasswordResetFailed: 'パスワードのリセットに失敗しました',
  ...
  AppLocale.rommMatchByHash: 'ハッシュで照合',
  AppLocale.rommMatchByHashBusy: 'ハッシュで照合中…',
  AppLocale.rommMatchByHashNoMatch: 'このファイルのハッシュを持つ RomM エントリはありません',
  AppLocale.rommMatchByHashSkipped: 'このファイルのハッシュを計算できません: {reason}',
  AppLocale.rommMatchByHashFailed: 'ハッシュでの照合に失敗しました',
  AppLocale.rommMatchByHashReasonDisc: 'ディスクイメージはハッシュ化されません',
  AppLocale.rommMatchByHashReasonOversize: 'ファイルが大きすぎてハッシュ化できません',
  ...
  AppLocale.rommUploadMenuItem: 'RomM にアップロード',
  AppLocale.rommUploadTitle: 'RomM にアップロード',
  AppLocale.rommUploadSystemRowTitle: 'RomM にないゲームをアップロード',
  AppLocale.rommUploadSystemRowSubtitle: 'このシステムのうち RomM にないゲームを送信します',
  AppLocale.rommUploadSystemRowRunning: '{name} をアップロード中（{current}/{total}）',
  AppLocale.rommUploadConfirmBody:
      '{count} 本のゲーム（{size}）を RomM へ順にアップロードします。プレイリストとディスクイメージはスキップされます。',
  ...
  AppLocale.rommUploadBusy: 'RomM へのアップロードはすでに実行中です',
  AppLocale.rommUploadNotOffered: 'RomM は現在アップロードを受け付けられません',
  AppLocale.rommUploadSummary:
      '{uploaded} 件アップロード、{skipped} 件スキップ、{failed} 件失敗',
  AppLocale.rommUploadSummaryCancelled: 'アップロードをキャンセルしました — {summary}',
  ...
  AppLocale.rommUploadMetadataPushed: '{count} 本のゲームの詳細を送信しました',
  AppLocale.rommUploadSkippedLine: 'スキップ {name}: {reason}',
  AppLocale.rommUploadFailedLine: '失敗 {name}: {reason}',
  AppLocale.rommUploadMore: '他 {count} 件',
  AppLocale.rommUploadSkipMultiFile: '複数ファイルのゲーム',
  AppLocale.rommUploadSkipDiscContainer: 'ディスクイメージ',
  AppLocale.rommUploadSkipMissing: 'ファイルが見つかりません',
  AppLocale.rommUploadSkipEmpty: '空のファイル',
  AppLocale.rommUploadSkipUnsendableName: 'ファイル名にサーバーが保存できない文字が含まれています',
  AppLocale.rommUploadSkipAlreadyExists: 'すでにサーバーにあります',
  AppLocale.rommUploadFailScopeDenied: 'この RomM アカウントは ROM を書き込めません',
  AppLocale.rommUploadFailCancelled: 'キャンセル',
