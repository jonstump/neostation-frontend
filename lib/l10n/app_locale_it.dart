...
const Map<String, dynamic> appLocaleIt = {
  ...
  AppLocale.rommSettings: 'Impostazioni RomM',
  ...
  AppLocale.scrapeFetchingFromRomm: 'Recupero dei metadati da RomM…',
  AppLocale.scrapeCompletedFromRomm: 'Scraping completato da RomM',
  AppLocale.scrapeCompletedFromScreenscraper:
      'Scraping completato da ScreenScraper',
  AppLocale.scrapeCompletedFallback:
      'RomM non aveva nulla per questo gioco; scraping completato da ScreenScraper',
  AppLocale.scrapeFailedWithReason: 'Scraping non riuscito: {reason}',
  AppLocale.scrapeSystemIdMissing: 'Errore: ID del sistema mancante.',
  AppLocale.scrapeSummaryFromRomm: 'Da RomM: {count}',
  AppLocale.scrapeSummaryFromScreenscraper: 'Da ScreenScraper: {count}',
  AppLocale.scrapeBulkRommOnlyStarted:
      'Scraping solo da RomM; ScreenScraper non è configurato',
  ...
  AppLocale.rommPairServerTooOld:
      'Questo server RomM è troppo vecchio per l\'associazione (richiede 4.8.0 o successivo)',

  // RomM firmware/BIOS panel (SPEC-0012)
  AppLocale.rommFirmwareRowTitle: 'File BIOS da RomM',
  AppLocale.rommFirmwareRowSubtitle:
      'Controlla quali file BIOS servono a questo sistema e scarica quelli mancanti',
  AppLocale.rommFirmwareRowRequiresConnection:
      'Collegati a RomM per gestire i file BIOS',
  AppLocale.rommFirmwarePanelTitle: 'File BIOS per {system}',
  AppLocale.rommFirmwareLoading: 'Caricamento dei file BIOS…',
  AppLocale.rommFirmwareEmpty: 'RomM non ha file BIOS per questa piattaforma',
  AppLocale.rommFirmwareScopeDenied:
      'Questo account RomM non ha accesso ai firmware',
  AppLocale.rommFirmwareListFailed: 'Impossibile caricare i file BIOS: {error}',
  AppLocale.rommFirmwareStatePresent: 'Presente',
  AppLocale.rommFirmwareStateMissing: 'Mancante',
  AppLocale.rommFirmwareStateServerMissing: 'Non presente sul server',
  AppLocale.rommFirmwareStateNoFolder: 'Nessuna cartella BIOS scelta',
  AppLocale.rommFirmwareVerifiedByServer: 'Verificato da RomM',
  AppLocale.rommFirmwareVerifyChecking: 'Controllo in corso…',
  AppLocale.rommFirmwareVerifyMatch: 'Corrisponde alla copia del server',
  AppLocale.rommFirmwareVerifyMismatch: 'Diverso dalla copia del server',
  AppLocale.rommFirmwareVerifyUnreadable: 'Impossibile leggere il file locale',
  AppLocale.rommFirmwareActionDownload: 'Scarica',
  AppLocale.rommFirmwareActionVerify: 'Verifica',
  AppLocale.rommFirmwareActionDownloadAll: 'Scarica tutti i mancanti',
  AppLocale.rommFirmwareActionChooseFolder: 'Scegli la cartella BIOS',
  AppLocale.rommFirmwareDestination: 'Destinazione: {path}',
  AppLocale.rommFirmwareDestinationMissing:
      'Scegli una cartella BIOS prima di scaricare',
  AppLocale.rommFirmwareFolderFailed:
      'Questa cartella non può essere usata per i file BIOS',
  AppLocale.rommFirmwareDownloadProgress: 'Download di {file} ({done}/{total})',
  AppLocale.rommFirmwareDownloadSummary:
      'File BIOS: {downloaded} scaricati, {failed} non riusciti',
  ...
  AppLocale.rommGalleryTitle: 'Galleria RomM',
  AppLocale.rommGalleryEmpty: 'Nessuno screenshot su RomM',
  AppLocale.rommGalleryError: 'Impossibile caricare la galleria RomM',
  ...
  AppLocale.rommFixMatchAction: 'Correggi la corrispondenza su RomM',
  AppLocale.rommChangeCoverAction: 'Cambia copertina',
  AppLocale.rommFixMatchTitle: 'Correggi la corrispondenza su RomM',
  AppLocale.rommChangeCoverTitle: 'Cambia copertina su RomM',
  AppLocale.rommFixMatchSearchHint: 'Cerca nelle fonti di metadati del server',
  AppLocale.rommFixMatchLoading: 'Interrogazione di RomM…',
  AppLocale.rommFixMatchNoResults: 'Nessun candidato trovato',
  AppLocale.rommFixMatchNoSource:
      'Questo server RomM non ha alcuna fonte di metadati attiva',
  AppLocale.rommFixMatchFailed:
      'La ricerca su RomM non è riuscita — seleziona per riprovare',
  AppLocale.rommFixMatchConfirmTitle: 'Applicare questa corrispondenza?',
  AppLocale.rommFixMatchConfirmBody:
      'RomM registrerà «{name}» come questo gioco per tutti i client e i metadati locali verranno sostituiti da RomM.',
  AppLocale.rommChangeCoverConfirmTitle: 'Applicare questa copertina?',
  AppLocale.rommChangeCoverConfirmBody:
      'RomM registrerà questa copertina per «{name}» per tutti i client e l’immagine locale verrà sostituita da RomM.',
  AppLocale.rommFixMatchApply: 'Applica su RomM',
  AppLocale.rommFixMatchApplying: 'Applicazione su RomM…',
  AppLocale.rommFixMatchApplied: 'Corrispondenza applicata su RomM',
  ...
  AppLocale.rommLoadPlatformsFailedDetail:
      'Impossibile caricare le piattaforme: {error}',
  ...
  AppLocale.rommServerVersionLine: 'Versione del server {version}',
  AppLocale.rommPasswordLoginDisabledHint:
      'L\'accesso con password è disabilitato su questo server',
  AppLocale.rommPushPlayState: 'Invia lo stato di gioco a RomM',
  AppLocale.rommPushPlayStateHint:
      'Invia a RomM le modifiche di nascosto, preferito e ultima partita dei giochi collegati',
  AppLocale.rommLinkSourceHash: 'Collegato tramite hash a {name}',
  AppLocale.rommMatchByHash: 'Abbina per hash',
  AppLocale.rommMatchByHashBusy: 'Abbinamento per hash…',
  AppLocale.rommMatchByHashNoMatch:
      'Nessuna voce RomM ha l\'hash di questo file',
  AppLocale.rommMatchByHashSkipped:
      'Impossibile calcolare l\'hash del file: {reason}',
  AppLocale.rommMatchByHashFailed: 'Abbinamento per hash non riuscito',
  AppLocale.rommMatchByHashReasonDisc: 'le immagini disco non vengono hashate',
  AppLocale.rommMatchByHashReasonOversize:
      'il file è troppo grande per calcolarne l\'hash',
  AppLocale.rommMatchByHashReasonMissing: 'il file non è stato trovato',
  ...
  AppLocale.rommRemoteBadge: 'Sul server RomM, non scaricato',
  AppLocale.rommRemoteRetryBadge:
      'Download non riuscito, premi A per riprovare',
  AppLocale.rommRemoteDownloadingBadge: 'Download {percent}%',
  AppLocale.rommRemoteDownloadingIndeterminate: 'Download in corso…',
  AppLocale.rommRemoteCancelDownload: 'Annulla download',
  AppLocale.rommRemoteDownloadConfirmTitle: 'Scarica da RomM',
  AppLocale.rommRemoteDownloadConfirmBody:
      'Scaricare {name} ({size}) in {folder}?',
  AppLocale.rommRemoteSizeUnknown: 'dimensione sconosciuta',
  AppLocale.rommRemoteCancelConfirmTitle: 'Annulla download',
  AppLocale.rommRemoteCancelConfirmBody:
      'Interrompere il download di {name}? Il file parziale verrà eliminato.',
  AppLocale.rommRemoteOfflineNotice:
      'Non disponibile offline: il server RomM non è raggiungibile',
  AppLocale.rommRemotePlayNow: 'Gioca ora',
  AppLocale.rommRemotePlayLater: 'Più tardi',
  AppLocale.rommRemoteDownloadReadyTitle: 'Download completato',
  AppLocale.rommRemoteDownloadReadyBody: '{name} è pronto per giocare.',
  AppLocale.rommRemoteSecondaryState: 'Sul server RomM, non scaricato',
  AppLocale.collectionPushRomm: 'Invia a RomM',
  AppLocale.collectionRommPushed: 'Inviata a RomM',
  AppLocale.collectionPushRommOutcome:
      '"{name}" inviata a RomM: {pushed} inviati, {unlinked} non collegati',
  AppLocale.collectionPushRommAlreadyExists:
      'Su RomM esiste già una collezione con questo nome',
  AppLocale.collectionPushRommDenied:
      'Questo accesso a RomM non può scrivere collezioni',
  AppLocale.collectionPushRommFailed: 'Impossibile inviare "{name}" a RomM',
  AppLocale.collectionDeleteRommTitle: 'Eliminare anche su RomM?',
  AppLocale.collectionDeleteRommBody:
      '"{name}" è stata inviata a RomM. Eliminarla anche lì o conservare la copia su RomM?',
  AppLocale.collectionDeleteRommConfirm: 'Elimina su RomM',
  AppLocale.collectionDeleteRommKeep: 'Conserva su RomM',
  AppLocale.collectionUnlinkPushedConfirm:
      'Questa collezione smetterà di inviare le sue modifiche a RomM. I suoi giochi restano qui e su RomM.',
  AppLocale.rommSyncOutcomeCollectionManagedHere:
      'La collezione "{name}" è gestita da questo dispositivo e non è stata aggiornata da RomM',
  AppLocale.collectionPushRommMembersQueued:
      '"{name}" è su RomM; i suoi giochi seguiranno quando il server sarà raggiungibile',
  AppLocale.neoSyncLoginSuccessfulEmailNotVerified:
      'Accesso effettuato, ma la tua e-mail non è ancora verificata',
  AppLocale.neoSyncVerificationEmailSent: 'E-mail di verifica inviata',
  ...
  AppLocale.rommUploadMetadataPushed: 'Dettagli inviati per {count} giochi',
