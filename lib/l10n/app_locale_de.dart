...
const Map<String, dynamic> appLocaleDe = {
  ...
  AppLocale.rommSyncConfirmLinked: '{count} mit RomM verknüpft.',
  ...
  AppLocale.inFolderImport: 'Metadaten aus ROM-Ordnern importieren',
  AppLocale.inFolderImportSubtitle:
      'gamelist.xml-Dateien und Artwork aus deinen ROM-Ordnern verwenden',
  AppLocale.inFolderImporting: 'Import aus ROM-Ordnern läuft',
  AppLocale.inFolderImportComplete: 'Import aus ROM-Ordnern abgeschlossen',
  AppLocale.inFolderImportNoGamelists:
      'In deinen ROM-Ordnern wurden keine gamelist.xml-Dateien gefunden',
  AppLocale.inFolderImportFoldersSkippedSaf:
      '{count} ROM-Ordner wurden übersprungen, da sie nicht als echte Pfade zugänglich sind (Android-Zugriff auf alle Dateien erforderlich)',
  AppLocale.inFolderSummarySystemsFound: 'Systeme gefunden',
  AppLocale.inFolderSummaryMediaOnlyLinked: 'Nur-Medien-Systeme verknüpft',
  AppLocale.inFolderSummaryFoldersSkippedSaf:
      'Übersprungene Ordner (kein Zugriff auf echten Pfad)',
  ...
  AppLocale.rommLinkPickerCleanedQuery: 'Ergebnisse für „{query}“',
  ...
  AppLocale.rommFetchMetadataRowSubtitle:
      'Metadaten und Artwork dieses Spiels von RomM ergänzen oder ersetzen',
  AppLocale.rommFetchMetadataRowNotLinked:
      'Verknüpfe dieses Spiel zuerst mit RomM',
  AppLocale.rommFetchMetadataAction: 'Abrufen',
  AppLocale.rommFetchMetadataChooserTitle: 'Metadaten von RomM abrufen',
  AppLocale.rommFetchMetadataFillGapsOption: 'Lücken füllen (empfohlen)',
  AppLocale.rommFetchMetadataFillGapsDescription:
      'Schreibt nur leere Felder und fehlendes Artwork. Alles, was bereits vorhanden ist, bleibt erhalten.',
  AppLocale.rommFetchMetadataReplaceOption: 'Alles ersetzen',
  AppLocale.rommFetchMetadataReplaceDescription:
      'Überschreibt alle Felder und Artworks mit den Daten von RomM. Nicht-englische Beschreibungen werden gelöscht und der Publisher bleibt leer, da RomM diese nicht bereitstellt.',
  AppLocale.rommFetchMetadataInProgress: 'Wird von RomM abgerufen…',
  AppLocale.rommFetchMetadataFilled:
      '{count} Felder und {media} Artworks von RomM ergänzt',
  AppLocale.rommFetchMetadataReplaced:
      '{count} Felder und {media} Artworks von RomM ersetzt',
  AppLocale.rommFetchMetadataNothingToFill:
      'Nichts zu ergänzen: dieses Spiel hat bereits alles, was RomM bereitstellt',
  AppLocale.rommFetchMetadataNotFound:
      'Nicht auf RomM gefunden: die verknüpfte ROM existiert dort nicht mehr',
  ...
  AppLocale.scrapeCompletedFromRomm: 'Von RomM gescrapt',
  AppLocale.scrapeCompletedFromScreenscraper: 'Von ScreenScraper gescrapt',
  AppLocale.scrapeCompletedFallback:
      'RomM hatte nichts zu diesem Spiel; von ScreenScraper gescrapt',
  AppLocale.scrapeFailedWithReason: 'Scraping fehlgeschlagen: {reason}',
  AppLocale.scrapeSystemIdMissing: 'Fehler: System-ID fehlt.',
  AppLocale.scrapeSummaryFromRomm: 'Von RomM: {count}',
  AppLocale.scrapeSummaryFromScreenscraper: 'Von ScreenScraper: {count}',
  AppLocale.scrapeBulkRommOnlyStarted:
      'Scraping nur über RomM; ScreenScraper ist nicht eingerichtet',
  ...
  AppLocale.rommScanQrAction: 'QR-Code scannen',
  AppLocale.rommScanQrTitle: 'Kopplungscode scannen',
  AppLocale.rommScanQrPrompt:
      'Richte die Kamera auf den in RomM angezeigten Kopplungs-QR-Code',
  AppLocale.rommScanQrNotPairingCode: 'Das ist kein RomM-Kopplungscode',
  ...
  AppLocale.rommSyncConfirmCollection:
      'Die Sammlung „{name}“ wird in NeoStation erstellt oder aktualisiert.',
  AppLocale.rommSyncOutcomeCollection: 'Sammlung „{name}“: {count} Spiele',
  AppLocale.rommSyncOutcomeCollectionFailed:
      'Sammlung „{name}“ konnte nicht aktualisiert werden',
  AppLocale.collectionRommMirrored: 'Von RomM synchronisiert',
  ...
  AppLocale.rommPairServerTooOld:
      'Dieser RomM-Server ist zu alt für die Kopplung (benötigt 4.8.0 oder neuer)',

  // RomM firmware/BIOS panel (SPEC-0012)
  AppLocale.rommFirmwareRowTitle: 'BIOS-Dateien von RomM',
  AppLocale.rommFirmwareRowSubtitle:
      'Prüfen, welche BIOS-Dateien dieses System braucht, und fehlende herunterladen',
  AppLocale.rommFirmwareRowRequiresConnection:
      'Mit RomM verbinden, um BIOS-Dateien zu verwalten',
  AppLocale.rommFirmwarePanelTitle: 'BIOS-Dateien für {system}',
  AppLocale.rommFirmwareLoading: 'BIOS-Dateien werden geladen…',
  AppLocale.rommFirmwareEmpty:
      'RomM hat keine BIOS-Dateien für diese Plattform',
  AppLocale.rommFirmwareScopeDenied:
      'Dieses RomM-Konto hat keinen Firmware-Zugriff',
  AppLocale.rommFirmwareListFailed:
      'BIOS-Dateien konnten nicht geladen werden: {error}',
  AppLocale.rommFirmwareStatePresent: 'Vorhanden',
  AppLocale.rommFirmwareStateMissing: 'Fehlt',
  AppLocale.rommFirmwareStateServerMissing: 'Nicht auf dem Server gespeichert',
  AppLocale.rommFirmwareStateNoFolder: 'Kein BIOS-Ordner gewählt',
  AppLocale.rommFirmwareVerifiedByServer: 'Von RomM verifiziert',
  AppLocale.rommFirmwareVerifyChecking: 'Wird geprüft…',
  AppLocale.rommFirmwareVerifyMatch: 'Stimmt mit der Serverkopie überein',
  AppLocale.rommFirmwareVerifyMismatch: 'Weicht von der Serverkopie ab',
  AppLocale.rommFirmwareVerifyUnreadable:
      'Die lokale Datei konnte nicht gelesen werden',
  AppLocale.rommFirmwareActionDownload: 'Herunterladen',
  AppLocale.rommFirmwareActionVerify: 'Prüfen',
  AppLocale.rommFirmwareActionDownloadAll: 'Alle fehlenden herunterladen',
  AppLocale.rommFirmwareActionChooseFolder: 'BIOS-Ordner wählen',
  AppLocale.rommFirmwareDestination: 'Ziel: {path}',
  AppLocale.rommFirmwareDestinationMissing:
      'Wähle einen BIOS-Ordner, bevor du herunterlädst',
  AppLocale.rommFirmwareFolderFailed:
      'Dieser Ordner kann nicht für BIOS-Dateien verwendet werden',
  AppLocale.rommFirmwareDownloadProgress:
      '{file} wird heruntergeladen ({done}/{total})',
  AppLocale.rommFirmwareDownloadSummary:
      'BIOS-Dateien: {downloaded} geladen, {failed} fehlgeschlagen',
  ...
  AppLocale.rommMaintenanceNotRunnable:
      'Dieser Server lässt NeoStation diese Aufgabe nicht starten. Starte sie in der RomM-Weboberfläche.',
  AppLocale.rommScanStatus: 'Scan-Status',
  AppLocale.rommScanWatchWaiting:
      'Server wird auf einen laufenden Scan geprüft …',
  AppLocale.rommScanWatchProgress: 'Scan läuft: {done} von {total} ROMs',
  AppLocale.rommScanWatchProgressUnknown:
      'Der Server scannt seine Bibliothek …',
  AppLocale.rommScanWatchResults:
      'Scan abgeschlossen: {new} neu, {identified} erkannt',
  AppLocale.rommScanWatchNothing:
      'Scan abgeschlossen. Es wurde nichts Neues gefunden.',
  AppLocale.rommScanWatchFailed: 'Der Scan auf dem Server ist fehlgeschlagen.',
  ...
  AppLocale.rommRemoteBadge: 'Auf dem RomM-Server, nicht heruntergeladen',
  AppLocale.rommRemoteRetryBadge:
      'Download fehlgeschlagen, A drücken zum Wiederholen',
  AppLocale.rommRemoteDownloadingBadge: 'Wird heruntergeladen {percent}%',
  AppLocale.rommRemoteDownloadingIndeterminate: 'Wird heruntergeladen…',
  AppLocale.rommRemoteCancelDownload: 'Download abbrechen',
  AppLocale.rommRemoteDownloadConfirmTitle: 'Von RomM herunterladen',
  AppLocale.rommRemoteDownloadConfirmBody:
      '{name} ({size}) nach {folder} herunterladen?',
  AppLocale.rommRemoteSizeUnknown: 'Größe unbekannt',
  AppLocale.rommRemoteCancelConfirmTitle: 'Download abbrechen',
  AppLocale.rommRemoteCancelConfirmBody:
      'Download von {name} abbrechen? Die unvollständige Datei wird verworfen.',
  AppLocale.rommRemoteOfflineNotice:
      'Offline nicht verfügbar: der RomM-Server ist nicht erreichbar',
  AppLocale.rommRemotePlayNow: 'Jetzt spielen',
  AppLocale.rommRemotePlayLater: 'Später',
  AppLocale.rommRemoteDownloadReadyTitle: 'Download abgeschlossen',
  ...
  AppLocale.rommUploadMenuItem: 'Zu RomM hochladen',
  AppLocale.rommUploadTitle: 'Zu RomM hochladen',
  AppLocale.rommUploadSystemRowTitle: 'In RomM fehlende Spiele hochladen',
  AppLocale.rommUploadSystemRowSubtitle:
      'Die Spiele dieses Systems senden, die RomM nicht hat',
  AppLocale.rommUploadSystemRowRunning: 'Lade {name} hoch ({current}/{total})',
  AppLocale.rommUploadConfirmBody:
      '{count} Spiele ({size}) werden nacheinander zu RomM hochgeladen. Playlists und Disc-Images werden übersprungen.',
  AppLocale.rommUploadConfirmAction: 'Hochladen',
  AppLocale.rommUploadPreparing: 'Upload zu RomM wird vorbereitet…',
  AppLocale.rommUploadProgress: 'Lade {name} hoch ({current}/{total})',
  AppLocale.rommUploadNoPlatform:
      'RomM hat keine Plattform für {system}. Lege sie auf deinem RomM-Server an und lade dann erneut hoch.',
  AppLocale.rommUploadUnknownSystem:
      'NeoStation kennt kein System namens {system} und kann daher keine RomM-Plattform wählen. Prüfe den Namen des ROM-Ordners.',
  AppLocale.rommUploadAmbiguousPlatform:
      'RomM hat mehrere Plattformen für {system}: {platforms}. Führe sie auf dem Server zusammen und lade dann erneut hoch.',
  AppLocale.rommUploadNothingToUpload:
      'Nichts hochzuladen: RomM hat bereits jedes Spiel von {system}',
  AppLocale.rommUploadAlreadyLinked:
      'Dieses Spiel ist bereits mit RomM verknüpft',
  AppLocale.rommUploadBusy: 'Ein Upload zu RomM läuft bereits',
  AppLocale.rommUploadNotOffered: 'RomM kann gerade keine Uploads annehmen',
  AppLocale.rommUploadSummary:
      '{uploaded} hochgeladen, {skipped} übersprungen, {failed} fehlgeschlagen',
  AppLocale.rommUploadSummaryCancelled: 'Upload abgebrochen — {summary}',
  AppLocale.rommUploadSummaryDisconnected:
      'Upload gestoppt, RomM ist nicht erreichbar — {summary}',
  AppLocale.rommUploadScanRequested:
      'Bibliotheksscan auf dem Server angefordert',
  AppLocale.rommUploadScanPending:
      'Wartet auf einen Bibliotheksscan auf dem Server',
  AppLocale.rommUploadScanRefused:
      'Hochgeladen, aber dieser Server lässt NeoStation keinen Scan starten. Starte einen in RomM, damit die Dateien indiziert werden.',
  AppLocale.rommUploadLinkNow: 'Jetzt verknüpfen',
  ...
  AppLocale.rommUploadSkipMultiFile: 'Spiel aus mehreren Dateien',
  AppLocale.rommUploadSkipDiscContainer: 'Disc-Image',
  AppLocale.rommUploadSkipMissing: 'Datei nicht gefunden',
  AppLocale.rommUploadSkipEmpty: 'leere Datei',
  AppLocale.rommUploadSkipUnsendableName:
      'der Dateiname enthält Zeichen, die der Server nicht speichern kann',
  AppLocale.rommUploadSkipAlreadyExists: 'bereits auf dem Server',
  AppLocale.rommUploadFailScopeDenied:
      'dieses RomM-Login darf keine ROMs schreiben',
  AppLocale.rommUploadFailCancelled: 'abgebrochen',
