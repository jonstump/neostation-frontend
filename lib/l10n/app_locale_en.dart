...
const Map<String, dynamic> appLocaleEn = {
  ...
  AppLocale.rommSettings: 'RomM Settings',
  ...
  AppLocale.inFolderImport: 'Import metadata from ROM folders',
  AppLocale.inFolderImportSubtitle:
      'Use gamelist.xml files and artwork found inside your ROM folders',
  AppLocale.inFolderImporting: 'Importing from ROM folders',
  AppLocale.inFolderImportComplete: 'ROM folder import complete',
  AppLocale.inFolderImportNoGamelists:
      'No gamelist.xml files were found in your ROM folders',
  AppLocale.inFolderImportFoldersSkippedSaf:
      '{count} ROM folders were skipped because they are not accessible as real paths (Android all-files access required)',
  AppLocale.inFolderSummarySystemsFound: 'Systems found',
  AppLocale.inFolderSummaryMediaOnlyLinked: 'Media-only systems linked',
  AppLocale.inFolderSummaryFoldersSkippedSaf:
      'Folders skipped (no real path access)',
  ...
  AppLocale.screenscraperDevCredentialsMissing:
      'This build has no ScreenScraper developer credentials, so ScreenScraper login and scraping are unavailable.',
  AppLocale.rommAuthModePairCode: 'Pairing code',
  AppLocale.rommPairCodeLabel: 'Pairing code',
  AppLocale.rommPairCodePlaceholder: 'XXXX-XXXX',
  AppLocale.rommPairCodeHint:
      'In RomM open Settings → Client API Tokens → Pair device. The code expires about a minute after it is generated.',
  AppLocale.rommPairCodeInvalidLength:
      'Enter the server URL and the 8-character pairing code (XXXX-XXXX)',
  AppLocale.rommPairCodeInvalid:
      'That pairing code is not valid; check the 8 characters',
  AppLocale.rommPairCodeExpired:
      'Pairing code expired or already used; generate a new one in RomM',
  ...
  AppLocale.rommLinkSourceHash: 'Linked by hash to {name}',
  AppLocale.rommMatchByHash: 'Match by hash',
  AppLocale.rommMatchByHashBusy: 'Matching by hash…',
  AppLocale.rommMatchByHashNoMatch: 'No RomM entry has this file\'s hash',
  AppLocale.rommMatchByHashSkipped: 'Could not hash this file: {reason}',
  AppLocale.rommMatchByHashFailed: 'Match by hash failed',
  AppLocale.rommMatchByHashReasonDisc: 'disc images are not hashed',
  AppLocale.rommMatchByHashReasonOversize: 'the file is too large to hash',
  AppLocale.rommMatchByHashReasonMissing: 'the file could not be found',
  ...
  AppLocale.neoSyncLoginSuccessfulEmailNotVerified:
      'Login successful, but your email is not verified yet',
  ...
  AppLocale.rommUploadNoPlatform:
      'RomM has no platform for {system}. Add it on your RomM server, then upload again.',
  AppLocale.rommUploadUnknownSystem:
      'NeoStation has no system called {system}, so it cannot choose a RomM platform. Check the ROM folder name.',
  AppLocale.rommUploadAmbiguousPlatform:
      'RomM has more than one platform for {system}: {platforms}. Merge them on the server, then upload again.',
  ...
  AppLocale.rommUploadMetadataPushed: 'Sent details for {count} games',
