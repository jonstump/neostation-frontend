...
const Map<String, dynamic> appLocaleKo = {
  ...
  AppLocale.rommScanQrAction: 'QR 코드 스캔',
  AppLocale.rommScanQrTitle: '페어링 코드 스캔',
  AppLocale.rommScanQrPrompt: 'RomM에 표시된 페어링 QR 코드에 카메라를 맞추세요',
  ...
  AppLocale.rommFirmwareRowTitle: 'RomM의 BIOS 파일',
  AppLocale.rommFirmwareRowSubtitle: '이 시스템에 필요한 BIOS 파일을 확인하고 없는 파일을 내려받습니다',
  AppLocale.rommFirmwareRowRequiresConnection: 'BIOS 파일을 관리하려면 RomM에 연결하세요',
  AppLocale.rommFirmwarePanelTitle: '{system}의 BIOS 파일',
  AppLocale.rommFirmwareLoading: 'BIOS 파일을 불러오는 중…',
  AppLocale.rommFirmwareEmpty: 'RomM에 이 플랫폼용 BIOS 파일이 없습니다',
  AppLocale.rommFirmwareScopeDenied: '이 RomM 계정에는 펌웨어 접근 권한이 없습니다',
  AppLocale.rommFirmwareListFailed: 'BIOS 파일을 불러오지 못했습니다: {error}',
  AppLocale.rommFirmwareStatePresent: '있음',
  AppLocale.rommFirmwareStateMissing: '없음',
  AppLocale.rommFirmwareStateServerMissing: '서버에 저장되어 있지 않음',
  AppLocale.rommFirmwareStateNoFolder: '선택된 BIOS 폴더 없음',
  AppLocale.rommFirmwareVerifiedByServer: 'RomM에서 검증됨',
  AppLocale.rommFirmwareVerifyChecking: '확인 중…',
  AppLocale.rommFirmwareVerifyMatch: '서버 사본과 일치',
  AppLocale.rommFirmwareVerifyMismatch: '서버 사본과 다름',
  AppLocale.rommFirmwareVerifyUnreadable: '로컬 파일을 읽을 수 없습니다',
  AppLocale.rommFirmwareActionDownload: '다운로드',
  AppLocale.rommFirmwareActionVerify: '검사',
  AppLocale.rommFirmwareActionDownloadAll: '없는 파일 모두 다운로드',
  AppLocale.rommFirmwareActionChooseFolder: 'BIOS 폴더 선택',
  AppLocale.rommFirmwareDestination: '저장 위치: {path}',
  AppLocale.rommFirmwareDestinationMissing: '다운로드하기 전에 BIOS 폴더를 선택하세요',
  AppLocale.rommFirmwareFolderFailed: '이 폴더는 BIOS 파일에 사용할 수 없습니다',
  AppLocale.rommFirmwareDownloadProgress: '{file} 다운로드 중 ({done}/{total})',
  ...
  AppLocale.rommFilterMenuTitle: '필터',
  AppLocale.rommFilterMenuAction: '필터',
  AppLocale.rommFilterFavorites: '즐겨찾기',
  AppLocale.rommFilterHasSaves: '세이브 있음',
  AppLocale.rommFilterHasStates: '상태 저장 있음',
  AppLocale.rommFilterHasAchievements: '업적 있음',
  AppLocale.rommFilterPlayable: '실행 가능',
  AppLocale.rommFilterDuplicates: '중복',
  AppLocale.rommFilterMissing: '파일 없음',
  AppLocale.rommFilterChipsLabel: '필터:',
  AppLocale.rommFilterClearAll: '필터 지우기',
  AppLocale.rommFilterNoMatches: '이 필터에 맞는 ROM이 없습니다',
  AppLocale.rommSurpriseMe: '무작위로 고르기',
  AppLocale.rommSurpriseMeEmpty: '여기에는 고를 것이 없습니다',
  ...
  AppLocale.rommMaintenanceRescanConfirm:
      'RomM이 라이브러리 전체를 다시 검사합니다. 큰 서버에서는 시간이 걸릴 수 있습니다.',
  AppLocale.rommMaintenanceSyncFolders: '폴더 검사 동기화',
  AppLocale.rommMaintenanceSyncFoldersConfirm:
      'RomM이 ROM 폴더를 다시 읽어 앱 밖에서 추가되거나 삭제된 파일을 반영합니다.',
  AppLocale.rommMaintenanceCleanup: '없어진 ROM 정리',
  AppLocale.rommMaintenanceCleanupConfirm:
      'RomM이 서버에 파일이 없는 라이브러리 항목을 삭제합니다. 되돌릴 수 없습니다.',
  AppLocale.rommMaintenanceRun: '실행',
  AppLocale.rommMaintenanceQueued: '서버에 작업을 예약했습니다',
  AppLocale.rommMaintenanceBusy: '해당 작업이 이미 실행 중입니다',
  AppLocale.rommMaintenanceFailed: '작업을 시작하지 못했습니다',
  AppLocale.rommFixMatchAction: 'RomM에서 매칭 수정',
  AppLocale.rommChangeCoverAction: '커버 변경',
  AppLocale.rommFixMatchTitle: 'RomM에서 매칭 수정',
  AppLocale.rommChangeCoverTitle: 'RomM에서 커버 변경',
  AppLocale.rommFixMatchSearchHint: '서버의 메타데이터 제공자 검색',
  AppLocale.rommFixMatchLoading: 'RomM에 조회하는 중…',
  AppLocale.rommFixMatchNoResults: '후보를 찾지 못했습니다',
  AppLocale.rommFixMatchNoSource: '이 RomM 서버에는 활성화된 메타데이터 제공자가 없습니다',
  AppLocale.rommFixMatchFailed: 'RomM 검색에 실패했습니다 — 선택하면 다시 시도합니다',
  AppLocale.rommFixMatchConfirmTitle: '이 매칭을 적용할까요?',
  AppLocale.rommFixMatchConfirmBody:
      'RomM이 모든 클라이언트에 이 게임을 “{name}”으로 저장하고, 로컬 메타데이터도 RomM의 내용으로 교체됩니다.',
  AppLocale.rommChangeCoverConfirmTitle: '이 커버를 적용할까요?',
  AppLocale.rommChangeCoverConfirmBody:
      'RomM이 모든 클라이언트에 “{name}”의 커버로 이 이미지를 저장하고, 로컬 이미지도 RomM의 내용으로 교체됩니다.',
  AppLocale.rommFixMatchApply: 'RomM에 적용',
  AppLocale.rommFixMatchApplying: 'RomM에 적용하는 중…',
  ...
  AppLocale.neoSyncNetworkError: '네트워크 오류: {error}',
  AppLocale.neoSyncServerError: '서버 오류: {error}',
  AppLocale.neoSyncLoginFailed: '로그인에 실패했습니다',
  AppLocale.neoSyncRegistrationFailed: '가입에 실패했습니다',
  AppLocale.neoSyncVerificationFailed: '인증에 실패했습니다',
  AppLocale.neoSyncResendVerificationFailed: '인증 이메일을 보내지 못했습니다',
  AppLocale.neoSyncPasswordResetEmailFailed: '비밀번호 재설정 이메일을 보내지 못했습니다',
  AppLocale.neoSyncPasswordResetFailed: '비밀번호를 재설정하지 못했습니다',
  ...
  AppLocale.rommRemoteBadge: 'RomM 서버에 있음, 다운로드되지 않음',
  AppLocale.rommRemoteRetryBadge: '다운로드 실패, A를 눌러 다시 시도',
  AppLocale.rommRemoteDownloadingBadge: '다운로드 중 {percent}%',
  AppLocale.rommRemoteDownloadingIndeterminate: '다운로드 중…',
  AppLocale.rommRemoteCancelDownload: '다운로드 취소',
  AppLocale.rommRemoteDownloadConfirmTitle: 'RomM에서 다운로드',
  AppLocale.rommRemoteDownloadConfirmBody:
      '{name}({size})을(를) {folder}에 다운로드할까요?',
  AppLocale.rommRemoteSizeUnknown: '크기 알 수 없음',
  AppLocale.rommRemoteCancelConfirmTitle: '다운로드 취소',
  AppLocale.rommRemoteCancelConfirmBody: '{name} 다운로드를 중지할까요? 불완전한 파일은 삭제됩니다.',
  AppLocale.rommRemoteOfflineNotice: '오프라인에서는 사용할 수 없음: RomM 서버에 연결할 수 없습니다',
  AppLocale.rommRemotePlayNow: '지금 플레이',
  AppLocale.rommRemotePlayLater: '나중에',
  ...
  AppLocale.rommUploadMenuItem: 'RomM에 업로드',
  AppLocale.rommUploadTitle: 'RomM에 업로드',
  AppLocale.rommUploadSystemRowTitle: 'RomM에 없는 게임 업로드',
  AppLocale.rommUploadSystemRowSubtitle: '이 시스템에서 RomM에 없는 게임을 보냅니다',
  AppLocale.rommUploadSystemRowRunning: '{name} 업로드 중 ({current}/{total})',
  AppLocale.rommUploadConfirmBody:
      '{count}개의 게임({size})이 RomM에 차례로 업로드됩니다. 재생 목록과 디스크 이미지는 건너뜁니다.',
  ...
  AppLocale.rommUploadBusy: 'RomM 업로드가 이미 진행 중입니다',
  AppLocale.rommUploadNotOffered: 'RomM이 지금은 업로드를 받을 수 없습니다',
  AppLocale.rommUploadSummary: '{uploaded}개 업로드, {skipped}개 건너뜀, {failed}개 실패',
  AppLocale.rommUploadSummaryCancelled: '업로드 취소됨 — {summary}',
  ...
  AppLocale.rommUploadSkipMultiFile: '다중 파일 게임',
  AppLocale.rommUploadSkipDiscContainer: '디스크 이미지',
  AppLocale.rommUploadSkipMissing: '파일을 찾을 수 없음',
  AppLocale.rommUploadSkipEmpty: '빈 파일',
  AppLocale.rommUploadSkipUnsendableName: '파일 이름에 서버가 저장할 수 없는 문자가 있습니다',
  AppLocale.rommUploadSkipAlreadyExists: '이미 서버에 있음',
  AppLocale.rommUploadFailScopeDenied: '이 RomM 계정은 ROM을 쓸 수 없습니다',
  AppLocale.rommUploadFailCancelled: '취소됨',
