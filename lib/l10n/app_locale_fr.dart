...
const Map<String, dynamic> appLocaleFr = {
  ...
  AppLocale.rommSettings: 'Paramètres RomM',
  ...
  AppLocale.rommSyncConfirmLinked: '{count} liés à RomM.',
  ...
  AppLocale.rommLinkPickerUnscoped:
      'Aucune plateforme RomM ne correspond à ce système : toutes les plateformes sont recherchées.',
  ...
  AppLocale.rommLinkPickerCleanedQuery: 'Résultats pour « {query} »',
  ...
  AppLocale.scrapeCompletedFromRomm: 'Scraping effectué depuis RomM',
  AppLocale.scrapeCompletedFromScreenscraper:
      'Scraping effectué depuis ScreenScraper',
  AppLocale.scrapeCompletedFallback:
      'RomM n’avait rien pour ce jeu ; scraping effectué depuis ScreenScraper',
  AppLocale.scrapeFailedWithReason: 'Échec du scraping : {reason}',
  AppLocale.scrapeSystemIdMissing: 'Erreur : l’ID du système est manquant.',
  AppLocale.scrapeSummaryFromRomm: 'Depuis RomM : {count}',
  AppLocale.scrapeSummaryFromScreenscraper: 'Depuis ScreenScraper : {count}',
  AppLocale.scrapeBulkRommOnlyStarted:
      "Scraping depuis RomM uniquement ; ScreenScraper n'est pas configuré",
  ...
  AppLocale.rommAuthModePairCode: 'Appairage',
  ...
  AppLocale.scraperScreenscraperOptional:
      'RomM est connecté et utilisé en premier pour le scraping. Connectez-vous à ScreenScraper pour l’ajouter comme source de secours.',
  AppLocale.scraperLoginToScreenscraper: 'Se connecter à ScreenScraper',
  ...
  AppLocale.scraperSubtitleRomm:
      'Télécharger les métadonnées des jeux depuis RomM',
  AppLocale.scraperSubtitleBoth:
      'Télécharger les métadonnées des jeux depuis RomM, ScreenScraper complétant ce que RomM n’a pas',
  AppLocale.rommSyncConfirmCollection:
      'La collection « {name} » sera créée ou mise à jour dans NeoStation.',
  AppLocale.rommSyncOutcomeCollection: 'Collection « {name} » : {count} jeux',
  AppLocale.rommSyncOutcomeCollectionFailed:
      'La collection « {name} » n\'a pas pu être mise à jour',
  AppLocale.collectionRommMirrored: 'Synchronisée depuis RomM',
  AppLocale.collectionUnlinkRomm: 'Dissocier de RomM',
  AppLocale.collectionUnlinkRommConfirm:
      'Cette collection ne suivra plus la collection RomM. Ses jeux sont conservés.',
  AppLocale.rommPairServerTooOld:
      'Ce serveur RomM est trop ancien pour l\'appairage (nécessite 4.8.0 ou plus récent)',

  // RomM firmware/BIOS panel (SPEC-0012)
  AppLocale.rommFirmwareRowTitle: 'Fichiers BIOS depuis RomM',
  AppLocale.rommFirmwareRowSubtitle:
      'Vérifiez les fichiers BIOS nécessaires à ce système et téléchargez ceux qui manquent',
  AppLocale.rommFirmwareRowRequiresConnection:
      'Connectez-vous à RomM pour gérer les fichiers BIOS',
  AppLocale.rommFirmwarePanelTitle: 'Fichiers BIOS pour {system}',
  AppLocale.rommFirmwareLoading: 'Chargement des fichiers BIOS…',
  AppLocale.rommFirmwareEmpty:
      "RomM n'a aucun fichier BIOS pour cette plateforme",
  AppLocale.rommFirmwareScopeDenied:
      "Ce compte RomM n'a pas accès aux firmwares",
  AppLocale.rommFirmwareListFailed:
      'Impossible de charger les fichiers BIOS : {error}',
  AppLocale.rommFirmwareStatePresent: 'Présent',
  AppLocale.rommFirmwareStateMissing: 'Manquant',
  AppLocale.rommFirmwareStateServerMissing: 'Absent du serveur',
  AppLocale.rommFirmwareStateNoFolder: 'Aucun dossier BIOS choisi',
  AppLocale.rommFirmwareVerifiedByServer: 'Vérifié par RomM',
  AppLocale.rommFirmwareVerifyChecking: 'Vérification…',
  AppLocale.rommFirmwareVerifyMatch: 'Identique à la copie du serveur',
  AppLocale.rommFirmwareVerifyMismatch: 'Différent de la copie du serveur',
  AppLocale.rommFirmwareVerifyUnreadable: 'Impossible de lire le fichier local',
  AppLocale.rommFirmwareActionDownload: 'Télécharger',
  AppLocale.rommFirmwareActionVerify: 'Vérifier',
  AppLocale.rommFirmwareActionDownloadAll: 'Télécharger tous les manquants',
  AppLocale.rommFirmwareActionChooseFolder: 'Choisir le dossier BIOS',
  AppLocale.rommFirmwareDestination: 'Destination : {path}',
  AppLocale.rommFirmwareDestinationMissing:
      'Choisissez un dossier BIOS avant de télécharger',
  AppLocale.rommFirmwareFolderFailed:
      'Ce dossier ne peut pas servir aux fichiers BIOS',
  AppLocale.rommFirmwareDownloadProgress:
      'Téléchargement de {file} ({done}/{total})',
  AppLocale.rommFirmwareDownloadSummary:
      'Fichiers BIOS : {downloaded} téléchargés, {failed} en échec',
  AppLocale.rommFirmwareDownloadCancelled:
      'Téléchargement des BIOS arrêté — {summary}',
  AppLocale.rommFirmwareDownloadFailedFile: 'Impossible de télécharger {file}',
  AppLocale.rommFavoritesCollectionName: 'Favoris',
  AppLocale.rommGalleryTitle: 'Galerie RomM',
  AppLocale.rommGalleryEmpty: 'Aucune capture sur RomM pour l’instant',
  AppLocale.rommGalleryError: 'Impossible de charger la galerie RomM',
  AppLocale.rommUploadScreenshots: 'Envoyer les captures vers RomM',
  AppLocale.rommUploadScreenshotsHint:
      'Envoie les nouvelles captures RetroArch vers RomM à la fin de chaque session',
  AppLocale.rommFirmwareDestinationRetroArch:
      'Destination (depuis RetroArch) : {path}',
  AppLocale.rommFilterMenuTitle: 'Filtres',
  AppLocale.rommFilterMenuAction: 'Filtres',
  AppLocale.rommFilterFavorites: 'Favoris',
  AppLocale.rommFilterHasSaves: 'Avec sauvegardes',
  AppLocale.rommFilterHasStates: 'Avec sauvegardes instantanées',
  AppLocale.rommFilterHasAchievements: 'Avec succès',
  AppLocale.rommFilterPlayable: 'Jouables',
  AppLocale.rommFilterDuplicates: 'Doublons',
  AppLocale.rommFilterMissing: 'Fichiers manquants',
  AppLocale.rommFilterChipsLabel: 'Filtres :',
  AppLocale.rommFilterClearAll: 'Effacer les filtres',
  AppLocale.rommFilterNoMatches: 'Aucune ROM ne correspond à ces filtres',
  AppLocale.rommSurpriseMe: 'Surprends-moi',
  AppLocale.rommSurpriseMeEmpty: 'Rien à tirer au sort ici',
  ...
  AppLocale.rommMaintenanceRescanConfirm:
      'RomM va réanalyser toute la bibliothèque. Cela peut être long sur un gros serveur.',
  AppLocale.rommMaintenanceSyncFolders: 'Synchroniser l\'analyse des dossiers',
  AppLocale.rommMaintenanceSyncFoldersConfirm:
      'RomM va relire ses dossiers de ROM et prendre en compte les fichiers ajoutés ou supprimés en dehors de l\'application.',
  AppLocale.rommMaintenanceCleanup: 'Nettoyer les ROM manquantes',
  AppLocale.rommMaintenanceCleanupConfirm:
      'RomM va supprimer les entrées de la bibliothèque dont les fichiers ne sont plus sur le serveur. Cette action est irréversible.',
  AppLocale.rommMaintenanceRun: 'Lancer',
  ...
  AppLocale.rommShowLibrary: 'Afficher la bibliothèque RomM dans mes systèmes',
  AppLocale.rommShowLibrarySubtitle:
      'Liste tous les jeux du serveur RomM sous leur système, marqués lorsqu’ils ne sont pas sur cet appareil',
  AppLocale.rommLibraryDefaultScope: 'Portée par défaut de la bibliothèque',
  AppLocale.rommLibraryDefaultScopeSubtitle:
      'Ce qu’une liste de jeux affiche à l’ouverture : tout le serveur ou seulement les jeux téléchargés',
  AppLocale.rommCoverCacheSize: 'Taille du cache des jaquettes RomM',
  AppLocale.rommCoverCacheSizeSubtitle:
      'Espace disque réservé aux jaquettes RomM pour que les jeux distants aient des visuels hors ligne',
  AppLocale.rommCoverCacheSizeValue: '{size} Mo',
  AppLocale.libraryScopeAll: 'Tous les jeux',
  AppLocale.libraryScopeDownloaded: 'Téléchargés',
  AppLocale.libraryScopeFooter: 'Bibliothèque : {scope}',
  AppLocale.libraryScopeToggle: 'Changer la portée de la bibliothèque',
  AppLocale.libraryOfflineCached:
      'Hors ligne — bibliothèque RomM en cache affichée',
  AppLocale.rommRemoteOnlySystemLabel: 'Uniquement sur le serveur RomM',
  AppLocale.rommRefreshLibraryNow: 'Actualiser la bibliothèque RomM maintenant',
  AppLocale.rommRefreshLibraryRunning: 'Actualisation de la bibliothèque RomM…',
  AppLocale.rommRefreshLibraryDone:
      'Bibliothèque RomM actualisée : {count} jeux sur {platforms} plateformes',
  AppLocale.rommRefreshLibraryFailed:
      'La bibliothèque RomM n’a pas pu être actualisée',
  AppLocale.rommRefreshLibraryUnavailable:
      'La bibliothèque RomM ne peut pas être actualisée pour le moment',
  AppLocale.rommClearCachedLibrary: 'Vider le cache de la bibliothèque RomM',
  AppLocale.rommClearCachedLibraryDone: 'Cache de la bibliothèque RomM vidé',
  ...
  AppLocale.rommUploadMenuItem: 'Envoyer vers RomM',
  AppLocale.rommUploadTitle: 'Envoyer vers RomM',
  AppLocale.rommUploadSystemRowTitle: 'Envoyer les jeux absents de RomM',
  AppLocale.rommUploadSystemRowSubtitle:
      'Envoyer les jeux de ce système que RomM ne possède pas',
  AppLocale.rommUploadSystemRowRunning: 'Envoi de {name} ({current}/{total})',
  AppLocale.rommUploadConfirmBody:
      '{count} jeux ({size}) seront envoyés vers RomM les uns après les autres. Les playlists et les images de disque sont ignorées.',
  AppLocale.rommUploadConfirmAction: 'Envoyer',
  ...
  AppLocale.rommUploadBusy: 'Un envoi vers RomM est déjà en cours',
  AppLocale.rommUploadNotOffered:
      'RomM ne peut pas recevoir d’envois pour le moment',
  AppLocale.rommUploadSummary:
      '{uploaded} envoyés, {skipped} ignorés, {failed} échoués',
  AppLocale.rommUploadSummaryCancelled: 'Envoi annulé — {summary}',
  AppLocale.rommUploadSummaryDisconnected:
      'Envoi interrompu, RomM est injoignable — {summary}',
  ...
  AppLocale.rommUploadLinkNowNothing:
      'Rien de lié pour l’instant ; le serveur analyse peut-être encore',
  AppLocale.rommUploadMetadataPushed: 'Détails envoyés pour {count} jeux',
  AppLocale.rommUploadSkippedLine: 'Ignoré {name} : {reason}',
  AppLocale.rommUploadFailedLine: 'Échec {name} : {reason}',
  AppLocale.rommUploadMore: '+{count} de plus',
  AppLocale.rommUploadSkipMultiFile: 'jeu multi-fichiers',
  AppLocale.rommUploadSkipDiscContainer: 'image de disque',
  AppLocale.rommUploadSkipMissing: 'fichier introuvable',
  AppLocale.rommUploadSkipEmpty: 'fichier vide',
  AppLocale.rommUploadSkipUnsendableName:
      'le nom du fichier contient des caractères que le serveur ne peut pas stocker',
  AppLocale.rommUploadSkipAlreadyExists: 'déjà sur le serveur',
  AppLocale.rommUploadFailScopeDenied:
      'cet identifiant RomM ne peut pas écrire de ROMs',
  AppLocale.rommUploadFailCancelled: 'annulé',
