...
const Map<String, dynamic> appLocaleEs = {
  ...
  AppLocale.rommSettings: 'Ajustes de RomM',
  ...
  AppLocale.rommFetchMetadataRowSubtitle:
      'Completar o reemplazar los metadatos y las imágenes de este juego desde RomM',
  AppLocale.rommFetchMetadataRowNotLinked:
      'Vincula este juego con RomM primero',
  AppLocale.rommFetchMetadataAction: 'Obtener',
  AppLocale.rommFetchMetadataChooserTitle: 'Obtener metadatos de RomM',
  AppLocale.rommFetchMetadataFillGapsOption: 'Rellenar huecos (recomendado)',
  AppLocale.rommFetchMetadataFillGapsDescription:
      'Escribe solo los campos vacíos y las imágenes que faltan. Todo lo que ya tienes se conserva.',
  AppLocale.rommFetchMetadataReplaceOption: 'Reemplazar todo',
  AppLocale.rommFetchMetadataReplaceDescription:
      'Sobrescribe todos los campos e imágenes con los datos de RomM. Las descripciones que no estén en inglés se borran y el editor queda vacío, ya que RomM no los proporciona.',
  AppLocale.rommFetchMetadataInProgress: 'Obteniendo de RomM…',
  AppLocale.rommFetchMetadataFilled:
      'Se completaron {count} campos y {media} imágenes desde RomM',
  AppLocale.rommFetchMetadataReplaced:
      'Se reemplazaron {count} campos y {media} imágenes desde RomM',
  AppLocale.rommFetchMetadataNothingToFill:
      'Nada que rellenar: este juego ya tiene todo lo que RomM proporciona',
  AppLocale.rommFetchMetadataNotFound:
      'No encontrado en RomM: la ROM vinculada ya no existe allí',
  ...
  AppLocale.rommSystemFetchRequiresConnection:
      'Conéctate a RomM para activar esta acción',
  AppLocale.rommSystemFetchRowRunning:
      'Obteniendo {done}/{total} — pulsa para cancelar',
  AppLocale.rommSystemFetchChooserTitle:
      'Obtener metadatos de RomM para {system}',
  AppLocale.rommSystemFetchModeFillGaps: 'Rellenar huecos (recomendado)',
  AppLocale.rommSystemFetchModeFillGapsHint:
      'Solo se escriben los campos vacíos y el arte que falta. Los datos existentes se conservan.',
  AppLocale.rommSystemFetchModeReplace: 'Reemplazar todo',
  AppLocale.rommSystemFetchModeReplaceWarning:
      'Sobrescribe todos los campos y archivos de arte. Las descripciones que no estén en inglés se borran y RomM no proporciona editor.',
  AppLocale.rommSystemFetchStarted:
      'Obteniendo metadatos de RomM para {system} en segundo plano',
  AppLocale.rommSystemFetchPreparing:
      'Preparando la obtención de metadatos de RomM para {system}…',
  AppLocale.rommSystemFetchProgress:
      'Obteniendo metadatos de RomM para {system}: {done}/{total}',
  AppLocale.rommSystemFetchSummary:
      'Metadatos de RomM para {system}: {linked} vinculados, {filled} rellenados, {replaced} reemplazados, {unlinked} sin vincular omitidos, {notFound} no encontrados, {failed} fallidos',
  ...
  AppLocale.scrapeFetchingFromRomm: 'Obteniendo metadatos de RomM…',
  AppLocale.scrapeCompletedFromRomm: 'Scraping completado desde RomM',
  AppLocale.scrapeCompletedFromScreenscraper:
      'Scraping completado desde ScreenScraper',
  AppLocale.scrapeCompletedFallback:
      'RomM no tenía nada para este juego; scraping completado desde ScreenScraper',
  AppLocale.scrapeFailedWithReason: 'Error de scraping: {reason}',
  AppLocale.scrapeSystemIdMissing: 'Error: falta el ID del sistema.',
  AppLocale.scrapeSummaryFromRomm: 'Desde RomM: {count}',
  AppLocale.scrapeSummaryFromScreenscraper: 'Desde ScreenScraper: {count}',
  AppLocale.scrapeBulkRommOnlyStarted:
      'Scraping solo desde RomM; ScreenScraper no está configurado',
  ...
  AppLocale.rommAuthModePairCode: 'Emparejar',
  ...
  AppLocale.rommScanQrAction: 'Escanear código QR',
  AppLocale.rommScanQrTitle: 'Escanear código de emparejamiento',
  AppLocale.rommScanQrPrompt:
      'Apunta la cámara al código QR de emparejamiento que muestra RomM',
  AppLocale.rommScanQrNotPairingCode:
      'Eso no es un código de emparejamiento de RomM',
  AppLocale.rommScanQrCameraDenied:
      'Se denegó el permiso de cámara; escribe el código en su lugar',
  AppLocale.rommScanQrCameraUnavailable:
      'No hay ninguna cámara disponible; escribe el código en su lugar',
  ...
  AppLocale.rommSyncConfirmCollection:
      'La colección «{name}» se creará o actualizará en NeoStation.',
  AppLocale.rommSyncOutcomeCollection: 'Colección «{name}»: {count} juegos',
  AppLocale.rommSyncOutcomeCollectionFailed:
      'No se pudo actualizar la colección «{name}»',
  AppLocale.collectionRommMirrored: 'Sincronizada desde RomM',
  AppLocale.collectionUnlinkRomm: 'Desvincular de RomM',
  ...
  AppLocale.rommScanWatchUnreachable:
      'No se pudo comprobar el escaneo en el servidor. Abre RomM para ver cómo va.',
  ...
  AppLocale.rommLoadPlatformsFailedDetail:
      'No se pudieron cargar las plataformas: {error}',
  ...
  AppLocale.rommPushPlayState: 'Enviar estado de juego a RomM',
  ...
  AppLocale.rommRemoteBadge: 'En el servidor RomM, no descargado',
  AppLocale.rommRemoteRetryBadge:
      'Error en la descarga, pulsa A para reintentar',
  AppLocale.rommRemoteDownloadingBadge: 'Descargando {percent}%',
  AppLocale.rommRemoteDownloadingIndeterminate: 'Descargando…',
  AppLocale.rommRemoteCancelDownload: 'Cancelar descarga',
  AppLocale.rommRemoteDownloadConfirmTitle: 'Descargar desde RomM',
  AppLocale.rommRemoteDownloadConfirmBody:
      '¿Descargar {name} ({size}) en {folder}?',
  AppLocale.rommRemoteSizeUnknown: 'tamaño desconocido',
  AppLocale.rommRemoteCancelConfirmTitle: 'Cancelar descarga',
  AppLocale.rommRemoteCancelConfirmBody:
      '¿Detener la descarga de {name}? El archivo parcial se descartará.',
  AppLocale.rommRemoteOfflineNotice:
      'No disponible sin conexión: no se puede acceder al servidor RomM',
  AppLocale.rommRemotePlayNow: 'Jugar ahora',
  AppLocale.rommRemotePlayLater: 'Más tarde',
  AppLocale.rommRemoteDownloadReadyTitle: 'Descarga completada',
  AppLocale.rommRemoteDownloadReadyBody: '{name} está listo para jugar.',
  AppLocale.rommRemoteSecondaryState: 'En el servidor RomM, no descargado',
  AppLocale.collectionPushRomm: 'Enviar a RomM',
  AppLocale.collectionRommPushed: 'Enviada a RomM',
  AppLocale.collectionPushRommOutcome:
      '"{name}" enviada a RomM: {pushed} enviados, {unlinked} sin vincular',
  AppLocale.collectionPushRommAlreadyExists:
      'Ya existe una colección con este nombre en RomM',
  AppLocale.collectionPushRommDenied:
      'Este inicio de sesión de RomM no puede escribir colecciones',
  AppLocale.collectionPushRommFailed: 'No se pudo enviar "{name}" a RomM',
  AppLocale.collectionDeleteRommTitle: '¿Eliminar también en RomM?',
  AppLocale.collectionDeleteRommBody:
      '"{name}" se envió a RomM. ¿Eliminarla también allí o conservar la copia de RomM?',
  AppLocale.collectionDeleteRommConfirm: 'Eliminar en RomM',
  AppLocale.collectionDeleteRommKeep: 'Conservar en RomM',
  ...
  AppLocale.neoSyncLoginSuccessfulEmailNotVerified:
      'Inicio de sesión con éxito, pero tu correo aún no está verificado',
  AppLocale.neoSyncVerificationEmailSent: 'Correo de verificación enviado',
  ...
  AppLocale.rommUploadNoPlatform:
      'RomM no tiene ninguna plataforma para {system}. Créala en tu servidor RomM y vuelve a subir.',
  AppLocale.rommUploadUnknownSystem:
      'NeoStation no conoce ningún sistema llamado {system}, así que no puede elegir una plataforma de RomM. Comprueba el nombre de la carpeta de ROM.',
  AppLocale.rommUploadAmbiguousPlatform:
      'RomM tiene más de una plataforma para {system}: {platforms}. Únelas en el servidor y vuelve a subir.',
